...
├── Ecommerce\_Analytics\_Dashboard.pbix
...
│   └── ecommerce\_data\_pipeline.ipynb

│

├── sql/

│   └── ecommerce\_analytics.sql
